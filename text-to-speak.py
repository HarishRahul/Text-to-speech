...
Logo=PhotoImage(file="icons/mice.png")
...
imageicon=PhotoImage(file="icons/speak.png")
btn=Button(root,text="Speak",compound=LEFT,image=imageicon,width=130,font="arial 14 bold",command=speaknow)
btn.place(x=550,y=280)

imageicon1=PhotoImage(file="icons/download.png")
save=Button(root,text="Speak",compound=LEFT,image=imageicon1,width=130,bg="#39c790",font="arial 14 bold",command=download)
